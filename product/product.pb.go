...
var file_proto_product_product_proto_rawDesc = []byte{
	...
	0x3a, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x32, 0x43, 0x0a, 0x0e, 0x50,
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x31, 0x0a,
	0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e,
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e,
...
var file_proto_product_product_proto_depIdxs = []int32{
	0, // 0: product.ProductService.List:input_type -> product.Empty
	1, // 1: product.ProductService.List:output_type -> product.ProductPayload
...
type ProductServiceClient interface {
	List(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ProductPayload, error)
}
...
func (c *productServiceClient) List(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ProductPayload, error) {
...
type ProductServiceServer interface {
	List(context.Context, *Empty) (*ProductPayload, error)
}
...
func (*UnimplementedProductServiceServer) List(context.Context, *Empty) (*ProductPayload, error) {
